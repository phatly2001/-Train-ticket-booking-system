			...
			<div class="card mb-4">
				<ul class="nav nav-pills  mb-3" id="pills-tab" role="tablist">
					<li class="nav-link " role="presentation"><a
						...
						aria-selected="true">Train Information</a></li>
											...
											<div class="col-md-6 mb-md-0 mb-4">
												<div class="card mb-4">
													...
													<div class="card-body px-0 pt-0 pb-2">
														<div class="row p-3">
															<div class=" col-6">
																<label for="exampleFormControlInput1" class="form-label">Train
															...
															<div class=" col-6">
																<label for="exampleFormControlTextarea1"
																	class="form-label">Train serial number </label> <input
																	type="email" class="form-control"
																	id="exampleFormControlInput1"
																	placeholder="Train serial number..">
															</div>
															<div class=" col-2">
